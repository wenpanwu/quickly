    ...
    return (
        <div className="container" style={{marginTop: '10px'}}>
            <div className="border rounded-5 row align-items-center">
                ...
                <section className="w-100 p-2 d-flex justify-content-center pb-2 fs-6">
                    {/* for error message*/}
                    <form>
                ...
                <section className="w-100 p-2 justify-content-center pb-2">
                    ...
                    <div style={{color: 'red', display: hasSignUpError ? '' : 'none', textAlign: 'center'}}>Sign Up failed! Please check the info you provided.</div>
                    <div style={{display: isSignUp ? '' : 'none', textAlign: 'center'}}>
